 ...
 * method assumes that if the file does not start with this text, the database is encrypted.
 *
 * @param path path to the database
 *
 * @return YES if the file starts with the expected text. NO if the file does not exist or
 * starts with the text mentioned before
 */
