...
/**
 ...
 Typically this is set with the initialiser.
 */
@property (nonatomic, copy, nullable) NSString *startSequenceValue;
 ...
 */
@property (nonatomic, copy, nullable) void (^documentChangedBlock)(CDTDocumentRevision * __nonnull revision);
...
/**
 ...
 operation or submitting it to a queue.
 */
@property (nonatomic, copy, nullable) void (^documentWithIDWasDeletedBlock)(NSString *__nonnull docId);
 ...
 */
@property (nonatomic, copy,nullable ) void (^fetchRecordChangesCompletionBlock)
